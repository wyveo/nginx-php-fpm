  ...
  <div class="container">
    <div class="row">
      <div class="one-half column" style="margin-top: 25%">
        ...
        <p>This page is being served from a <strong>docker</strong> container running Nginx with PHP-FPM 7.x</p>
        <p><strong>NGINX: </strong>v<?php echo $_ENV['NGINX_VERSION'] ?><br><strong>PHP-FPM: </strong>v<?php echo phpversion(); ?></p>
