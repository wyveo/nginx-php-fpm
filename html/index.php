  ...
  <div class="container">
    <div class="row">
      <div class="one-half column" style="margin-top: 25%">
        ...
        <p>You have successfully launched a <strong>docker</strong> container running <strong>NGINX</strong> with <strong>PHP-FPM 7.x</strong></p>
        <p><strong>NGINX: </strong>v<?php echo $_ENV['NGINX_VERSION'] ?><br><strong>PHP-FPM: </strong>v<?php echo phpversion(); ?><br><strong>HOSTNAME: </strong><?php echo gethostname(); ?></p>
